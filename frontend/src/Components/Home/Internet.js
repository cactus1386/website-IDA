...
function Application() {
  return (<>
    <div className="container mt-5 bg-blue fontv text-light" dir="rtl" style={{ padding: '10px', borderRadius: '15px' }}>
      <div className="row">
        <div className="col-md-6 pt-2" style={{paddingRight:"40px"}}>
          <span className="fontv h2">
          اینترنت اشیا صنعتی</span>
        <br/>
        <div class="pt-2">
            <span >
          ...
          <div className="pt-3 pb-3" style={{ marginRight: "40px" }}>
        ...
        <div className="col-md-6 d-flex justify-content-center align-items-center">
          <div className="text-center">
            <img src={lpwan} className="img-fluid rounded mb-3" alt="SCADA Mission" />
          </div>
        </div>
      </div>
    </div>
