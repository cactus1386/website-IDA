...
function Application() {
  return (<> 
    <div class="col-md-12 bg-blue fontv" style={{ height: '600px' }}>
        <div class="col-md-4">
          <div class="pt-5">
            <div class="card " style={{height:'500px'}}>
              <div style={{ paddingTop: '80px' ,paddingRight:'30px'}}><img src={applic} class=" Imagw "/></div>
              <div style={{paddingRight:'30px'}}><img src={scada} class=" Imagw "/></div>         
            </div> 
          </div>
        </div>
