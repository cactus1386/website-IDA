        ...
        <div className="container mt-5" dir="rtl">
            ...
            <div className="row mt-5 align-items-center section">
                ...
                <div className="col-md-6 text-md-left">
                    <h2 className="fontv">تمرکز اصلی شرکت</h2>
                    <p className="fontv">
            ...
            <div className="row mt-5 align-items-center section">
                ...
                <div className="col-md-6 text-md-left">
                    <h2 className="fontv">تکنولوژی LPWAN</h2>
                    <p className="fontv">
            ...
            <div className="row mt-5 align-items-center section">
                ...
                <div className="col-md-6 text-md-right">
                    <h2 className="fontv">مانیتورینگ و کنترل فرآیندها</h2>
                    <p className="fontv">
            ...
            <div className="row mt-5 align-items-center section">
                ...
                <div className="col-md-6 text-md-left">
                    <h2 className="fontv">سیستم‌های اسکادا</h2>
                    <p className="fontv">
            ...
            <div className="row mt-5">
                <div className="col text-center">
                    <h2 className="fontv">ارتباط با ما</h2>
